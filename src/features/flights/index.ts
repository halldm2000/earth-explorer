...
function getOrCreateDataSource(viewer: Cesium.Viewer): Cesium.CustomDataSource {
  ...
  // Entity clustering — configured but off by default (toggle via "cluster flights")
  // Flights use efficient incremental entity updates so clustering isn't needed for perf
